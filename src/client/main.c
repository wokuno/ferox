...
static void run_demo_mode(void) {
    ...
    ProtoColony demo_colonies[] = {
        {1, "Bacillus feroxii", 40.0f, 30.0f, 8.0f, 150, 150, 0.5f, 255, 100, 100, true, 0, 0.0f, 0.0f},
        {2, "Streptococcus viridis", 120.0f, 50.0f, 12.0f, 300, 300, 0.7f, 100, 255, 100, true, 0, 0.0f, 0.0f},
        {3, "Lactobacillus azurae", 70.0f, 100.0f, 6.0f, 80, 80, 0.3f, 100, 100, 255, true, 0, 0.0f, 0.0f},
        {4, "Clostridium aureum", 180.0f, 70.0f, 10.0f, 200, 200, 0.6f, 255, 255, 100, true, 0, 0.0f, 0.0f},
        {5, "Enterococcus roseus", 240.0f, 120.0f, 5.0f, 50, 50, 0.2f, 255, 100, 255, true, 0, 0.0f, 0.0f},
        {6, "Pseudomonas cyanea", 300.0f, 40.0f, 9.0f, 180, 180, 0.55f, 50, 200, 255, true, 0, 0.0f, 0.0f},
        {7, "Staphylococcus amber", 340.0f, 140.0f, 7.0f, 120, 120, 0.4f, 255, 180, 50, true, 0, 0.0f, 0.0f},
        {8, "Escherichia verdant", 90.0f, 160.0f, 11.0f, 250, 250, 0.65f, 50, 255, 50, true, 0, 0.0f, 0.0f},
        {9, "Salmonella crimson", 160.0f, 130.0f, 6.0f, 90, 90, 0.35f, 200, 50, 50, true, 0, 0.0f, 0.0f},
        {10, "Klebsiella indigo", 260.0f, 90.0f, 8.0f, 160, 160, 0.5f, 100, 50, 200, true, 0, 0.0f, 0.0f},
        {11, "Proteus teal", 30.0f, 110.0f, 5.0f, 60, 60, 0.25f, 50, 200, 180, true, 0, 0.0f, 0.0f},
        {12, "Serratia coral", 370.0f, 80.0f, 7.0f, 110, 110, 0.45f, 255, 130, 100, true, 0, 0.0f, 0.0f},
        {13, "Acinetobacter olive", 200.0f, 170.0f, 9.0f, 170, 170, 0.5f, 150, 180, 50, true, 0, 0.0f, 0.0f},
        {14, "Moraxella violet", 110.0f, 20.0f, 6.0f, 85, 85, 0.3f, 180, 100, 220, true, 0, 0.0f, 0.0f},
        {15, "Neisseria gold", 280.0f, 150.0f, 10.0f, 210, 210, 0.6f, 255, 215, 0, true, 0, 0.0f, 0.0f},
        {16, "Vibrio azure", 50.0f, 180.0f, 7.0f, 130, 130, 0.45f, 80, 150, 255, true, 0, 0.0f, 0.0f},
        {17, "Rickettsia ruby", 320.0f, 25.0f, 8.0f, 140, 140, 0.5f, 220, 50, 80, true, 0, 0.0f, 0.0f},
        {18, "Bordetella mint", 150.0f, 180.0f, 6.0f, 100, 100, 0.35f, 100, 220, 150, true, 0, 0.0f, 0.0f},
        {19, "Legionella peach", 380.0f, 170.0f, 9.0f, 190, 190, 0.55f, 255, 180, 150, true, 0, 0.0f, 0.0f},
        {20, "Brucella slate", 220.0f, 35.0f, 7.0f, 115, 115, 0.4f, 100, 120, 140, true, 0, 0.0f, 0.0f},
        {21, "Francisella lime", 60.0f, 60.0f, 5.0f, 70, 70, 0.25f, 180, 255, 100, true, 0, 0.0f, 0.0f},
        {22, "Coxiella bronze", 350.0f, 100.0f, 8.0f, 155, 155, 0.5f, 200, 150, 80, true, 0, 0.0f, 0.0f},
        {23, "Bartonella plum", 130.0f, 85.0f, 6.0f, 95, 95, 0.35f, 150, 80, 180, true, 0, 0.0f, 0.0f},
        {24, "Ehrlichia sage", 270.0f, 185.0f, 10.0f, 200, 200, 0.6f, 140, 180, 140, true, 0, 0.0f, 0.0f},
        {25, "Anaplasma rose", 15.0f, 150.0f, 7.0f, 125, 125, 0.45f, 255, 150, 180, true, 0, 0.0f, 0.0f},
        {26, "Orientia ocean", 190.0f, 15.0f, 8.0f, 145, 145, 0.5f, 50, 120, 200, true, 0, 0.0f, 0.0f},
        {27, "Neorickettsia sun", 310.0f, 60.0f, 6.0f, 85, 85, 0.3f, 255, 220, 100, true, 0, 0.0f, 0.0f},
        {28, "Wolbachia forest", 85.0f, 140.0f, 9.0f, 175, 175, 0.55f, 60, 140, 80, true, 0, 0.0f, 0.0f},
        {29, "Chlamydia sky", 360.0f, 130.0f, 7.0f, 120, 120, 0.4f, 135, 200, 235, true, 0, 0.0f, 0.0f},
        {30, "Spiroplasma ember", 240.0f, 55.0f, 8.0f, 150, 150, 0.5f, 255, 100, 50, true, 0, 0.0f, 0.0f},
    };
