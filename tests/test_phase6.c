...
static int test_client_selects_next_alive_colony(void) {
    ...
    c->local_world.colonies[0] = (proto_colony){1, "Alpha", 10.0f, 10.0f, 5.0f, 50, 50, 0.5f, 255, 0, 0, true, 0, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
    c->local_world.colonies[1] = (proto_colony){2, "Beta", 20.0f, 20.0f, 5.0f, 50, 50, 0.5f, 0, 255, 0, false, 0, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f}; // dead
    c->local_world.colonies[2] = (proto_colony){3, "Gamma", 30.0f, 30.0f, 5.0f, 50, 50, 0.5f, 0, 0, 255, true, 0, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
...
static int test_client_get_selected_returns_correct_colony(void) {
    ...
    c->local_world.colonies[0] = (proto_colony){1, "Alpha", 10.0f, 10.0f, 5.0f, 50, 50, 0.5f, 255, 0, 0, true, 0, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
    c->local_world.colonies[1] = (proto_colony){2, "Beta", 20.0f, 20.0f, 5.0f, 50, 50, 0.5f, 0, 255, 0, true, 0, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
    
    // No selection initially
    const proto_colony* sel = client_get_selected_colony(c);
    if (sel != NULL) {
        client_destroy(c);
        return 0;
    }
